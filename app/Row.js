...
export default class Row extends Component {
  ...
  renderFrontface() {
    return (
      <InfoCard onPress={this.flip} profile={this.props.profile}/>
    );
  }

  renderBackface() {
    return (
      <ProfileCard onPress={this.flip} profile={this.props.profile}/>
    );
  }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <PhotoCard onPress={this.flip} profile={this.props.profile}/>
        </FoldView>
